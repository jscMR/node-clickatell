...
var MODE = {'http':http,'rest':rest,'soap':soap,'xml':xml};
...
Clickatell.prototype.sendmsg = function(args,callback){
  this.module.sendMsg(args,callback);
